...
#ARREGLOS
# c = array[0,1][0,7] of string; pbytc = array[0,1][0,7] of integer; tdp = array[0,7] of char; ldp = array[0,2] of string; pnc = array[0,2][0,7] of integer; pnp = array[0,7] of int; patNetProd = array[0,7] of int
...
# contadorGirasol : int
# contadorCebada : int
# contadorDeRecibidos : int
# contadorDeCuposOtorgados : int
# pesoNetoTrigo : int
# pesoNetoSoja : int
# pesoNetoMaiz : int
# pesoNetoGirasol : int
# pesoNetoCebada : int
# pesoNetoMayorTrigo : int  
# pesoNetoMayorSoja : int
# pesoNetoMayorMaiz : int
# pesoNetoMayorGirasol : int
# pesoNetoMayorCebada : int
# pesoNetoMenorTrigo : int  
# pesoNetoMenorSoja : int 
# pesoNetoMenorMaiz : int 
# pesoNetoMenorGirasol : int 
# pesoNetoMenorCebada : int 
# opcion: int
